                            ...
                            ant_lev_page_16_data_t const *p_page_data)
{
    ...
    p_outcoming_data->display_command_lsb = ((uint8_t)p_page_data->current_front_gear << 4);p_outcoming_data->manufacturer_id_msb = ((uint8_t)(p_page_data->manufacturer_id >> 8)) & 0x0F;
}
